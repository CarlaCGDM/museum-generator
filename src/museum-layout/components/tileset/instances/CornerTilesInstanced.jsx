...
const CornerTileInstanced = ({ positions = [], directions = [], tileSize = 1, roomPosition, innerGroupOffset }) => {
  ...
  const wallLODGlbs = useLoader(GLTFLoader, [
    '/models/tiles/Wall_LODs/LOD_02_Green.glb',
    '/models/tiles/Wall_LODs/LOD_00_Red.glb',
    '/models/tiles/Wall_LODs/LOD_01_Blue.glb',
  ]);
...
export default CornerTileInstanced;
